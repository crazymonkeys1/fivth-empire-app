...
export const FE_PEOPLE = [
  ...
  // ===== Root Stage =====
  { id: "julia", name: "Julia Pieper", role: "Yoga teacher", initials: "JP", image: "https://instagram.flis8-1.fna.fbcdn.net/v/t51.82787-19/643563318_18572192434020129_3964716325910946702_n.jpg?efg=eyJ2ZW5jb2RlX3RhZyI6InByb2ZpbGVfcGljLmRqYW5nby43MjMuYzIifQ&_nc_ht=instagram.flis8-1.fna.fbcdn.net&_nc_cat=109&_nc_oc=Q6cZ2gFx_d48ZImnTqkjBQxA_0-tmaQQCaRqzM4vGnj1__ez_fdQ8YjpgrDXs8wI0mVKs4Q&_nc_ohc=9XrmKnwJ2PgQ7kNvwEe_H_j&_nc_gid=epolQzt13o94eIjlMHMoAQ&edm=APoiHPcBAAAA&ccb=7-5&oh=00_Af4HkNS1RLsUBd6PX5ElXRq5CyCzc_TcBbIVR-E24pR8fg&oe=69FC5244&_nc_sid=22de04", bio: "Leads movement-as-meditation. Her practice opens the day on the Root Stage with a slow flow under the trees.", tag: "Ritual & Embodiment" },
...
export const FE_PARTNERS = [
  ...
  { id: "backstage", name: "Backstage", category: "App · Technology", logo: null, short: "The team that built this app. A small studio turning gatherings into something people actually remember.", long: "Backstage is a small, opinionated studio building digital experiences for events, festivals, and gatherings that matter. They don't do templated ticketing or off-the-shelf apps. They sit with you, understand what you're actually trying to do, and build something that feels like it belongs. This app — the schedule, the voices, the map, the offline mode — was made by them. Cooked with love from Ericeira.", web: "gowithbackstage.com", role: "This App · Built with Care" },
];
